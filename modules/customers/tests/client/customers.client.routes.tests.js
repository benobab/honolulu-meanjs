  ...
  describe('Customers Route Tests', function () {
    ...
    describe('Route Config', function () {
      ...
      describe('List Route', function () {
        var liststate;
        beforeEach(inject(function ($state) {
          liststate = $state.get('customers.list');
        }));
        ...
        it('Should have templateUrl', function () {
          expect(liststate.templateUrl).toBe('modules/customers/client/views/list-customers.client.view.html');
        });
      });
      ...
      describe('Handle Trailing Slash', function () {
        ...
        it('Should remove trailing slash', inject(function ($state, $location, $rootScope) {
          ...
          expect($state.current.templateUrl).toBe('modules/customers/client/views/list-customers.client.view.html');
        }));
      });
    });
  });
